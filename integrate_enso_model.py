...
# em.train_model(harmonic_pred = 'none', quad = False, delay_model = False)

# em.integrate_model(10, int_length = em.data.shape[0]+1000, sigma = 0.1, n_workers = 5, diagnostics = True, noise_type = 'seasonal')
# em.reconstruct_simulated_field(lats = [-5, 5], lons = [190, 240], mean = True)

# print em.reconstructions.shape
# import scipy.io as sio
# sio.savemat("Nino34-linear-10PCsel-L3-seasonal-surrs.mat", {'N34s' : em.reconstructions})
