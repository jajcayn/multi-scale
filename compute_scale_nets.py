...
for method in METHODS:
    ...
    net.save_net('networks/NCEP-SATsurface-7-8yrs-Hilb-phase-adjmat%s.bin' % (method), only_matrix = True)
    ...
    net.save_net('networks/NCEP-SATsurface-7-8yrs-Hilb-amplitude-adjmat%s.bin' % (method), only_matrix = True)
    ...
    net.save_net('networks/NCEP-SATsurface-7-8yrs-Hilb-reconstructed-signal-adjmat%s.bin' % (method), only_matrix = True)
