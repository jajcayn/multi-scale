...
net = ScaleSpecificNetwork('%sair.mon.mean.levels.nc' % path_to_data, 'air', 
                            date(1948,1,1), date(2015,1,1), None, None, 0, dataset = "NCEP", sampling = 'monthly', anom = False)
...
with open("WeMO-JFM_ann_means-NCEP-phase-fluc-%dFTsurrs-from-indices.bin" % NUM_SURR, "wb") as f:
